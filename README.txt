...
Overview:
    ...
    7. Source code can be found in 'src/'. This includes 'indexing_server.cpp' and 'peer.cpp', as well as the Makefile to compile the executables and build the peer directories.